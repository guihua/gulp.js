...
var TouchSlide = function(a) {
	...
	var effect = opts.effect,
		...
		conBox = obj( opts.mainCell, slideCell )[0];
	...
	var conBoxSize = conBox.children.length,
		navObj = obj(opts.titCell, slideCell);
	...
	var index = parseInt(opts.defaultIndex),
		...
		loop = (opts.pnLoop == "false" || opts.pnLoop == false) ? false : true,
		oldIndex = index,
		inter = null,	// autoPlay的setInterval
		timeout = null,		// leftLoop的setTimeout
		endTimeout = null;	//translate的setTimeout
